...
try:
    ...
    #rospy.loginfo(msg)("PyKEEN successfully imported")
...
class PyKEENGraphManager:
    def __init__(self, data_path="data/knowledge_graph/"):
        ...
        #rospy.loginfo(msg)(f"Simple PyKEEN Graph Manager initialized (PyKEEN available: {PYKEEN_AVAILABLE})")
    ...
    def load_data(self):
        ...
        try:
            ...
            #rospy.loginfo(msg)(f"Loaded {len(self.triples)} triples from storage")
    ...
    def add_triple(self, subject, predicate, object_):
        ...
        if triple not in self.triples:
            ...
            #rospy.loginfo(msg)(f"Added triple: {subject} --{predicate}--> {object_}")
            ...
            if (PYKEEN_AVAILABLE and 
                ...
                #rospy.loginfo(msg)("Attempting model training...")
                self.train_model_safe()
    ...
    def train_model_safe(self):
        ...
        try:
            #rospy.loginfo(msg)(f"Starting safe training with {len(self.triples)} triples...")
            ...
            #rospy.loginfo(msg)(f"Training with batch_size={safe_batch_size}, epochs={self.training_epochs}")
            ...
            #rospy.loginfo(msg)("✅ PyKEEN model training completed successfully!")
            return True
    ...
    def _prepare_training_data_safe(self):
        ...
        try:
            ...
            #rospy.loginfo(msg)(f"Preparing {len(df)} unique triples")
            ...
            #rospy.loginfo(msg)(f"TriplesFactory created: {self.triples_factory.num_entities} entities, {self.triples_factory.num_relations} relations")
            return True
    ...
    def _get_fallback_embedding(self, person_id):
        ...
        #rospy.loginfo(msg)(f"Generated fallback embedding for {person_id}: shape {embedding.shape}")
        return embedding
