...
class TiagoCameraManager:
    ...
    def get_current_image(self):
        ...
        Returns:
            numpy.ndarray: Current image in OpenCV format (BGR), or None if no image available
        """
        with self.image_lock:
    ...
    def capture_image(self, filename=None, save=True):
        ...
        Args:
            filename (str, optional): Specific filename for the image
            save (bool): Whether to save the image to disk
            
        Returns:
            numpy.ndarray: Captured image in OpenCV format, or fallback if camera not available
        """
    ...
    def capture_for_face_recognition(self):
        ...
        Returns:
            numpy.ndarray: Image in RGB format suitable for face_recognition library
        """
    ...
    def get_image_stats(self):
        ...
        Returns:
            dict: Image statistics including dimensions, channels, etc.
        """
        current_img = self.get_current_image()
