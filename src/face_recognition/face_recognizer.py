...
class OpenCVFaceRecognizer:
    def __init__(self, db_path="data/faces/"):
        ...
        Args:
            db_path (str): Path to store face data
        """
    ...
    def detect_faces(self, image):
        ...
        Args:
            image (numpy.ndarray): Input image (BGR or RGB)
    ...
    def add_face(self, image, person_id, person_name=None, save_photo=True):
        ...
        Args:
            image (numpy.ndarray): Image containing the face (BGR format)
            person_id (str): Unique identifier for the person
            person_name (str, optional): Human-readable name
            save_photo (bool): Whether to save the photo
